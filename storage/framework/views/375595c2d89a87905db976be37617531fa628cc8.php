                                 ...
                                 <div class="title">
                                   ...
                                   <br>
                                    ...
                                    <div class="response-area">
                                                ...
                                                <div class="post-comment">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="answer-comment col-sm-12">
                                                            <form action="<?php echo e(action('questionController@addComment',[$replies->id])); ?>" method="post">
                                        ...
                                        <?php else: ?>
                                            <form style="margin-top: 10px;" action="<?php echo e(action('questionController@addAnswer',[$questions->id])); ?>" method="post" class="col-md-10"><input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
