        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <img src="<?php echo e(URL::asset('asset/images/helmet.png')); ?>" class="margin-bottom" alt="">
            ...
            <div class="row">
                <div class="about-us">
                    <div class="col-sm-7 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="<?php echo e(URL::asset('asset/images/logo1.png')); ?>" class="img-responsive" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div class="item active">
                                ...
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                            <img src="<?php echo e(URL::asset('asset/images/aboutus/2222.jpg')); ?>" class="img-responsive" alt="">
                                        </div>
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                            <img src="<?php echo e(URL::asset('asset/images/aboutus/nayem.jpg')); ?>" class="img-responsive" alt="">
                                        </div>
                                        <div class="social-profile">
                                            <ul class="nav nav-pills">
                                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                            <img src="<?php echo e(URL::asset('asset/images/aboutus/tanvir.jpg')); ?>" class="img-responsive" alt="">
                                        </div>
                                        <div class="social-profile">
                                            <ul class="nav nav-pills">
                                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                            <img src="<?php echo e(URL::asset('asset/images/aboutus/chondra.jpg')); ?>" class="img-responsive" alt="">
                                        </div>
                                        <div class="social-profile">
                                            <ul class="nav nav-pills">
                                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
