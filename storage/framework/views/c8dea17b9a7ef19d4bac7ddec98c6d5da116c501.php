...
<?php $__env->startSection('content'); ?>
    <div class="col-md-8">
        ...
        <div id="tab-group">
                ...
                <form action="<?php echo e(url('questions')); ?>" method="post" class="col-md-20"><input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                    <div class="form-group">
                        <label for="title">Title: </label>

                        <input type="text" class="form-control" id="title-input"  name="title"  value="<?php echo e(old('title')); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="body-input" rows="14" cols="15" name="body"  required><?php echo e(old('body')); ?></textarea>
                    </div>
                                            ...
                                            <div class="col-sm-2 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                                                <div class="feature-inner">
                                                     <div class="form-group">
                                                            ...
                                                            <input id="radio" type="radio"  value="<?php echo e($tags->id); ?>" name="tag_id">

                                                            <label for="tag_id" >

                                                                <?php echo e($tags->tag_name); ?>
                    ...
                    <?php /*<input type="hidden" value="0" name="marking" >*/ ?>
                </form>
