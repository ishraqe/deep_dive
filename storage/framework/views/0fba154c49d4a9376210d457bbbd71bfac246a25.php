            ...
            <div class="row">
                ...
                <div class="col-sm-3 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                    <div class="feature-inner">
                        ...
                        <h2><a style="  display: inline-block; margin-right: auto;   font-size: large" href="<?php echo e(action('tagController@description',[$tags->id])); ?>"><?php echo e($tags->tag_name); ?></a></h2>
