...
@section('content')
    ...
    <br>
    <form class="navbar-form" role="search" action="{{url('/tagSearch')}}" >
            ...
            <div class="row">
                ...
                <div class="col-sm-3 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                    <div class="feature-inner">
                        ...
                        <h2><a style="  display: inline-block; margin-right: auto;   font-size: large" href="{{action('tagController@description',[$tags->id])}}">{{ucfirst($tags->tag_name)}}</a></h2>
